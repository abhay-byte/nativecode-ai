# Regression results — 20260729T143332Z

- ADB: `192.168.1.52:43055`
- Envs: `proot-distro,proot-fast`
- Offline: `0`
...
RESULT proot-fast p1_dev SUMMARY pass=9 fail=0 skip=7
### env=proot-fast script=p1_ai
RESULT proot-fast p1_ai SUMMARY pass=6 fail=0 skip=9
