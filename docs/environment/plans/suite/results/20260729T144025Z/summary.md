# Regression results — 20260729T144025Z

- ADB: `192.168.1.52:43055`
- Envs: `proot-fast,proot-distro,chroot`
- Offline: `0`
...
RESULT proot-fast p0 SUMMARY pass=13 fail=0 skip=0
### env=proot-fast script=p1_dev
RESULT proot-fast p1_dev SUMMARY pass=11 fail=0 skip=5
### env=proot-fast script=p1_ai
RESULT proot-fast p1_ai SUMMARY pass=10 fail=0 skip=5
### env=proot-distro script=p0
RESULT proot-distro p0 SUMMARY pass=13 fail=0 skip=0
### env=proot-distro script=p1_dev
RESULT proot-distro p1_dev SUMMARY pass=11 fail=0 skip=5
### env=proot-distro script=p1_ai
RESULT proot-distro p1_ai SUMMARY pass=10 fail=0 skip=5
